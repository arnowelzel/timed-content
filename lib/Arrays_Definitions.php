...
if ( !isset( $timed_content_rule_freq_array ) )
    $timed_content_rule_freq_array = array( 0 => __( "Hourly", 'timed-content' ),
...
if ( !isset( $timed_content_rule_days_array ) )
	$timed_content_rule_days_array = array( 0 => __( "Sundays", 'timed-content' ),
...
if ( !isset( $timed_content_rule_ordinal_array ) )
	$timed_content_rule_ordinal_array = array( 0 => __( "first", 'timed-content' ),
...
if ( !isset( $timed_content_rule_ordinal_days_array ) )
	$timed_content_rule_ordinal_days_array = array( 0 => __( "Sunday", 'timed-content' ),
