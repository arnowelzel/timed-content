    ...
    <div id="client_panel" class="panel current">
        <form name="TimedContentDialogClient" id="TimedContentDialogClient"
            ...
            <fieldset>
                ...
                <p><label
                        for="client_show_minutes"><?php _ex('Time (mm:ss)', 'TinyMCE Dialog - Time count label', 'timed-content'); ?>
                        :</label>
                ...
                <p><label
                        for="client_show_fade"><?php _ex('Fade in (ms)', 'TinyMCE Dialog - Fade-in label', 'timed-content'); ?>
                        :</label>
            ...
            <fieldset>
                ...
                <p><label
                        for="client_hide_minutes"><?php _ex('Time (mm:ss)', 'TinyMCE Dialog - Time count label', 'timed-content'); ?>
                        :</label>
                ...
                <p><label
                        for="client_hide_fade"><?php _ex('Fade out (ms)', 'TinyMCE Dialog - Fade-out label', 'timed-content'); ?>
                        :</label>
